...
HTTP 请求报文由**请求行、请求头、和消息主体**组成。如果有消息主体，那么请求头之后的空行是必须的，用来表示请求头结束：
...
参考：[HTTP 报文格式](https://imageslr.github.io/2020/http.html#http-%E6%8A%A5%E6%96%87%E6%A0%BC%E5%BC%8F)
...
<details>
<summary>集线器、网桥、交换机、路由器分别位于哪一层？</summary>
